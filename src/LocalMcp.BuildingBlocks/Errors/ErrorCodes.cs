...
public static class ErrorCodes
{
    ...
    public const string ProcessMismatch = "PROCESS_MISMATCH";
    public const string ProcessKillProtected = "PROCESS_KILL_PROTECTED";
    public const string ProcessKillFailed = "PROCESS_KILL_FAILED";
    public const string ClipboardUnavailable = "CLIPBOARD_UNAVAILABLE";
    public const string ClipboardReadFailed = "CLIPBOARD_READ_FAILED";
    public const string ClipboardWriteFailed = "CLIPBOARD_WRITE_FAILED";
    public const string ClipboardVerificationFailed = "CLIPBOARD_VERIFICATION_FAILED";
    public const string FileDialogFieldNotFound = "FILE_DIALOG_FIELD_NOT_FOUND";
    public const string FileDialogPathSetFailed = "FILE_DIALOG_PATH_SET_FAILED";
    public const string FileDialogPathVerificationFailed = "FILE_DIALOG_PATH_VERIFICATION_FAILED";
    public const string FileDialogSubmitFailed = "FILE_DIALOG_SUBMIT_FAILED";
