        ...
        _connection.On<JsonElement>("ReceiveCommand", async (json) =>
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        nameof(WorkspaceListCommand) => JsonSerializer.Deserialize<WorkspaceListCommand>(rawJson, JsonOptions.Default),
                        nameof(WorkspaceResolveCommand) => JsonSerializer.Deserialize<WorkspaceResolveCommand>(rawJson, JsonOptions.Default),
                        ...
                        nameof(PowerShellStartCommand) => JsonSerializer.Deserialize<PowerShellStartCommand>(rawJson, JsonOptions.Default),
                        nameof(PowerShellStatusCommand) => JsonSerializer.Deserialize<PowerShellStatusCommand>(rawJson, JsonOptions.Default),
                        nameof(PowerShellCancelCommand) => JsonSerializer.Deserialize<PowerShellCancelCommand>(rawJson, JsonOptions.Default),
