...
public sealed partial class GatewayConnection
{
    private static AgentCommand? DeserializeExtendedCommand(string? typeName, string rawJson) =>
        typeName switch
        {
            ...
            nameof(ProcessListCommand) => JsonSerializer.Deserialize<ProcessListCommand>(rawJson, JsonOptions.Default),
            nameof(ProcessKillCommand) => JsonSerializer.Deserialize<ProcessKillCommand>(rawJson, JsonOptions.Default),
            ...
            nameof(ClipboardGetCommand) => JsonSerializer.Deserialize<ClipboardGetCommand>(rawJson, JsonOptions.Default),
            nameof(ClipboardSetCommand) => JsonSerializer.Deserialize<ClipboardSetCommand>(rawJson, JsonOptions.Default),
            nameof(FileDialogSetPathCommand) => JsonSerializer.Deserialize<FileDialogSetPathCommand>(rawJson, JsonOptions.Default),
